    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            SectionHeader(title: '1. General'),
            SectionBody(
              text:
                  'Cancer Shop is an e-commerce platform offering supportive products for individuals affected by cancer. We aim to provide comfort, care, and dignity through our range of curated products.',
            ),
            SectionHeader(title: '2. Eligibility'),
            SectionBody(
              text:
                  'You must be at least 18 years old or the age of majority in your jurisdiction to use this website. By using Cancer Shop, you represent that you meet these requirements.',
            ),
